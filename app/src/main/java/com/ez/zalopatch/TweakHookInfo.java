...
final class TweakHookInfo {
    ...
    static Info forKey(String key, SymbolSchema.Active schema) {
        ...
        switch (key) {
            ...
            case Tweaks.KEY_BLOCK_TYPING_STATUS:
                ...
                break;
            case Tweaks.KEY_ALWAYS_SEE_ONLINE_STATUS:
                path = schema.string("symbols.chat.online_status_flag_class", "yz.j") + "#"
                        + schema.string("symbols.chat.online_status_flag_method", "j2") + "()";
                break;
    ...
    private static List<String> driftSymbols(String key, SymbolSchema.Active schema) {
        switch (key) {
            ...
            case Tweaks.KEY_ALWAYS_SEE_ONLINE_STATUS:
                return Arrays.asList(
                        schema.string("symbols.chat.online_status_flag_class", "yz.j"),
                        "#" + schema.string("symbols.chat.online_status_flag_method", "j2") + "()");
            default:
